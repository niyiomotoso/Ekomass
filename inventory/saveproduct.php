...
$insert_image="INSERT INTO inventory (item, price, qtyleft,imagename,description,category, application, datasheet) VALUES('$proname', '$price','$qty','$imagename','$description','$category','$application', '$datasheet')";
