...
<ol id="toc">
    ...
    <li><a href="#editprice"><span>Add Daily Sales</span></a></li>
    <li><a href="#alert"><span>Monitor</span></a></li>
...
$sql=query("select * from inventory");
$i=1;
...
<td>
<a href="edititem?item=<?=$ind?>"><span class="text"><?php echo $item; ?></span> </a>
</td>
<td>
...
<?php
$sqls=query("select * from sales where date='$da' and product_id='$id'");
...
$result1 = query("SELECT sum(sales) FROM sales where date='$da'");
...
<div class="content" id="alert">
	...
	<?php
	$CRITICAL=10;
	$sql2=query("select * from inventory where qtyleft<='$CRITICAL'");
...
<div class="content" id="sales">
	<form action="tableedit.php#sales" method="post">
	 ...
	 Total Sales:  
	  ...
	  $a=$_POST['from'];
	  $b=$_POST['to'];
		$result1 = query("SELECT sum(sales) FROM sales where date BETWEEN '$a' AND '$b'");
		while($row = mysqli_fetch_array($result1))
		{
			$rrr=$row['sum(sales)'];
			echo formatMoney($rrr, true);
...
<form action="updateproduct.php" method="post">
	...
	Product name:<?php
	$name= query("select * from inventory");
...
<div class="content" id="quantitysold">
<form action="quantity sold.php" method="post">
	<div style="margin-left: 48px;">
	Product name:<?php
	$name= query("select * from inventory");
	...
	<br />
	Quantity Sold:<input name="itemnumber" type="text" /><br />
	<div style="margin-left: 127px; margin-top: 14px;"><input name="" type="submit" value="Add" /></div>
</form>
</div>
<div class="content" id="addpro">

	<form enctype="multipart/form-data" action="saveproduct.php" method="post">
	<div style="margin-left: 48px;">
		Add item image
	...
	<div style="margin-left: 48px;">
	Product description:<textarea  style="height: 388px; width: 388px" name="description" type="text" ></textarea>
	</div>
	<br/>
	<div style="margin-left: 97px;">
	...
	<br />
	<div style="margin-left: 97px;">
	Tag:<input  style="height: 88px; width: 288px"  name="tag" type="text" />
	</div>
	<br />
	<div style="margin-left: 97px;">
	Datasheet:<textarea  style="height: 88px; width: 288px"  name="datasheet" type="text" ></textarea>
	</div>
	<br />
	<div style="margin-left: 97px;">
	Application:<textarea  style="height: 88px; width: 288px"  name="application" type="text" ></textarea>
	</div>
...
DATE: <input name="from" type="text" class="tcal"/><br>
	<div style="margin-left: 48px;">
	Product name:<?php
	$name= query("select * from inventory");
	...
	<br />
	Quantity Sold: <input name="price"  type="text" />
...
<script type="text/javascript">
activatables('page', ['inventory', 'alert', 'sales', 'addproitem', 'addpro', 'editprice','quantitysold']);
</script>
</body>
</html>
