...
// If file has uploaded successfully, store its name in data base
	smart_resize_image('../inventory/'.$filepath,
  	...
  	//exit();
	//$insert_image="";
$insert_image="INSERT INTO inventory (item, price, qtyleft,imagename,description,category, application, datasheet) VALUES('$proname', '$price','$qty','$filepath','$description','$category','$application', '$datasheet')";

if($dbconn->query($insert_image))

{
 header("Location: ../admin_new_item?productstored");
}
else
{
