...
$i=1;
$end=$date_looper+ 3;
$initial_date_looper=$date_looper;
                              ...
                              $date_looperrrr=0;
                                ...
                                while($date_looper < $end and $date_looper < count($date_storer)){
...
?>" class="text">
<?php $fm->formatCommas($price); ?></span>
</td>
</tr>
...
Page 
<?php
	$fm->doPagination($date_storer, 3, "admin_load_sales", $initial_date_looper);
?>
