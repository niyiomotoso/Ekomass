        ...
        <div class="row">   
          <?php include_once 'menu.php'  ?>
            ...
            <div class="col-sm-8">
                ...
                <form id="main-contact-form"  method="post" action="view/editprofile.php" role="form">
                <div class="row">
                  <div class="center">
                 <!--
                    ...
                    <p>Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor.</p>  -->
                            ...
                            <div class="form-group">
                               Shipping Address: <textarea  type="text" class="form-control" name="city"   required="required" placeholder="Please fill this" ><?=$_SESSION['vanizon_user']['city']?></textarea>
                            </div>
                            
                              First Name:   <input type="text" name="firstname" class="form-control" value="<?= $_SESSION['vanizon_user']['firstname']?>" required="required" placeholder="Please fill this">
                            </div>
                          
                            <div class="form-group">
                                E mail: <input type="text" name="email" class="form-control"  value="<?= $_SESSION['vanizon_user']['email']?>" required="required" placeholder="Please fill this">
                            </div>
                     
                            
                            <div class="form-group ">
                               Phone: <input type="text" name="phone" class="form-control"  value="<?= $_SESSION['vanizon_user']['phone']?>" required="required" placeholder="Please fill this">
                            </div>
